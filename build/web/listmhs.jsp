<%-- 
    Document   : listmhs
    Created on : Feb 12, 2015, 1:45:57 PM
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <a href="${pageContext.request.contextPath}/addmhs.jsp" class="btn btn-primary">Add Record</a><br/><br/>
     
<s:property value="coba"/>
           ...
           <s:iterator value="mhss" var="mh" status="stat">
                <tr>
                    <td><% out.print(""+i++);%></td>
